...
class PostController
{
  ...
  public function postLike($USERID, $POSTID)
  {
    ...
    $createNotificationQry = $this->conn->prepare("INSERT INTO notifications (user_id, post_id, content) VALUES (?, ?, ?)");
    $createNotificationQry->bind_param('iis', $ownerInfo['user_id'], $POSTID, $message);
